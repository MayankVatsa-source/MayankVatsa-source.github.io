...
1. It was found during the analysis of data ,that on Wednesday Afternoon during Summer season ,there are maximum number of riders.The company may go for attarctive offers to the casual riders such as,

   a) offring free ride length or ride-time.
   b) Introducing point systems based on riding length to the rider which can be utilized to avail free ride length or discount.
   c) Offering free gifts after completing a specified number of days.

2. It has been noticed that at certain starting stations there are maximum number of casual members.So company should focus on those stations specifically to casual riders. Efforts should be made to covert casual riders to annual members by taking steps like promoting new offers like free membership ,free ride length  for new members at those stations making casual members aware of the benefit of becoming annual members.

3. The company should also take notice that the existing member riders should not leave their membership.This can be done by providing certain attractie benefits exclusively for member riders so that they continue as annual members.

4. The company should carry on a survey among the casual riders for:
